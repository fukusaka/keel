...
/**
 * Test certificate fixtures for Node.js engine TLS tests. Same material
 * as the other TLS test modules — self-signed RSA 2048-bit server cert
 * (CN=localhost) plus a separately-rooted client CA and a client cert
 * signed by it to exercise mTLS trust anchor pinning.
 */
internal object NodeTestCertificates {
