 ...
 *
 * To install keel's [TlsHandler] on a server pipeline, wrap the factory in
 * `TlsCodecServerInstaller` (in `:keel-server`) and pass it as the
 * `installer` of `TlsServerConfig`.
 *
