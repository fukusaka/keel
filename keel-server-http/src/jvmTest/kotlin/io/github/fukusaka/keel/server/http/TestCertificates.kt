 ...
 *
 * The same certificate the other keel TLS modules use, copied here so the
 * HTTPS integration test has a server identity without depending on
 * another module's test fixtures. For test use only.
 */
