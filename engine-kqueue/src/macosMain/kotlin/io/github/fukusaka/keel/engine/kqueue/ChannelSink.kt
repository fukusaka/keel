...
/**
 * Bridges [KqueueChannel] to kotlinx-io [RawSink] for codec layer integration.
 *
 ...
 *
 * Uses [runBlocking] to bridge the suspend [KqueueChannel.write]/[KqueueChannel.flush]
 ...
 *
 * Engine-layer code should use [KqueueChannel.write]/[KqueueChannel.flush]
...
internal class ChannelSink(
    ...
    override fun write(source: Buffer, byteCount: Long) {
        ...
        while (remaining > 0) {
            val chunkSize = remaining.coerceAtMost(KqueueChannel.CODEC_BUFFER_SIZE)
