...
- `testing-server-http`: new `keel-testing-server-http` module — `keelHttpTestClient { }` exercises `keelHttpServer` routes in-process, with no engine or socket, for unit tests (#550)
