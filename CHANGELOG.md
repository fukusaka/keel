...
- Dokka: expand `benchmark/module.md` with standalone binary build commands, Phase 2 Native servers (Rust/Go/Swift/Zig), benchmark script reference, and missing JVM pipeline engines (`pipeline-http-nio`, `pipeline-http-netty`)
