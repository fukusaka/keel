...
- `website`: add an HTTP Server DSL reference page — a guided tour of the `keelHttpServer { }` builder (routing, path patterns, middleware, route groups, WebSocket, static files, error handling) for first-time developers (#564)
