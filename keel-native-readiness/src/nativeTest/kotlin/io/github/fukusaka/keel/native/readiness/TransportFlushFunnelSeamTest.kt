 ...
 * pinned by the sibling [TransportFlushExitSeamTest], and the
 * published-instance rule — what may still touch an answer once it has been
 * handed out — by [TransportPublishedAnswerSeamTest]. Outside the
