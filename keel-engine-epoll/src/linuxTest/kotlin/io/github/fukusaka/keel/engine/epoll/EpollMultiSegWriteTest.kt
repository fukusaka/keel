...
/**
 * Verifies that the epoll transport correctly writes a *multi-segment*
 ...
 *
 * Mirrors `KqueueMultiSegWriteTest` for the kqueue companion engine —
 * same shape, same test names, applied to the Linux POSIX writev path.
 */
@OptIn(ExperimentalForeignApi::class)
class EpollMultiSegWriteTest {
