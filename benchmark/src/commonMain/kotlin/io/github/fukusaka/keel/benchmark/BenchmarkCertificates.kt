...
/**
 * Self-signed test certificate for HTTPS benchmarking.
 *
 * CN=localhost, RSA 2048-bit, valid 2026-04 to 2027-04.
 * Same certificate used in `KeelEngineHttpsTest`.
 */
...
""".trimIndent() + "\n"
    ...
    /** Create [TlsConfig] with the self-signed benchmark certificate. */
    fun tlsConfig(): TlsConfig = TlsConfig(
