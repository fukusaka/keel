 ...
 * surface the cheapest possible "parse" cost on the keel pipeline-http
 * direct pipeline so it can be compared against framework parsers (Ktor /
 * Spring / Vertx / Netty) on the same wire shape. The bytes are
 * `"--KeelBenchBoundaryV1"`
